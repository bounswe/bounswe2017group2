...
class ConcertSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.date_time = validated_data.('date_time',instance.date_time)
        instance.description = validated_data.('description',instance.date_time)
        instance.price_min = validated_data.('price_min', instance.price_min)
        instance.price_max = validated_data.('prica_max', instance.price_max)
